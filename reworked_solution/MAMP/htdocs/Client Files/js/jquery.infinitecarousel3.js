	...
	$.fn.extend({ 
		infiniteCarousel: function(options)
		{
			...
			var options = $.extend(defaults, options);
				...
				for(var i=0;i<numItems;i++) $('div.ic_tray',obj).append('<div style="overflow:hidden; no-repeat scroll 50% 50% #ddd;float:left;position:relative;width:'+widthSource+'px;height:'+heightSource+'px;" class="infiniteCarousel_item">');
